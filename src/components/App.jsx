...
function App() {
    ...
    return (<>
            ...
            <Footer />
            <PopupWithForm title="Обновить аватар" name="edit_avatar" onClose={closeAllPopups} isOpen={isEditAvatarPopupOpen}>
            ...
            <PopupWithForm title="Редактировать профиль" name="edit_profile" onClose={closeAllPopups} isOpen={isEditProfilePopupOpen}>
                <fieldset className="form__set">
                    <label className="form__field">
                        <input className="form__input" name="name" type="text" minLength={2} maxLength={40} required/>
                    ...
                    <label className="form__field">
                        <input className="form__input" name="about" type="text" minLength={2} maxLength={200} required/>
            ...
            <PopupWithForm title="Новое место" name="add_place" buttonLabel="Создать" onClose={closeAllPopups} isOpen={isAddPlacePopupOpen}>
                <fieldset className="form__set">
                    <label className="form__field">
                        <input className="form__input" name="name" type="text" minLength={2} maxLength={30} required/>
                    ...
                    <label className="form__field">
                        ...
                        <span className="form__placeholder place-link-input-placeholder">Ссылка на картинку:</span>
                        <span className="form__input-error place-link-input-error"/>
                    </label>
                </fieldset>
            </PopupWithForm>
