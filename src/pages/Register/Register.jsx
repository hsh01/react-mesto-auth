...
const Register = () => {
    ...
    return (<>
            ...
            <SignForm name="register" title="Регистрация" onSubmit={handleSubmit} buttonDisabled={isButtonDisabled} buttonLabel="Зарегистрироваться">
                <fieldset className="form__set">
                    <Input title="Email" name="email" type="email" onChange={handleChange} error={formErrors.email} value={formValues.email} dark={true}/>
                    <Input title="Пароль" name="password" type="password" minLength={8} onChange={handleChange} error={formErrors.password} value={formValues.password} dark={true}/>
                </fieldset>
            </SignForm>
